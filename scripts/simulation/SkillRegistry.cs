...
namespace Sporeholm.Simulation
{
	...
	public static class SkillRegistry
	{
		...
		public static readonly IReadOnlyList<SkillDef> All = new[]
		{
			...
			// v0.8.0 (Phase 8) — 13th skill. Taming, tending, breeding + farm work.
			// Raises taming success, breeding rate, and animal-produce yield/quality.
			new SkillDef("Husbandry",    "Survival",  "Taming, breeding, and tending animals, plus farm work. Levels via Tame / Tend / Plant / Harvest tasks."),
		};
		...
		{
			["Forager"]   = new() { ["Botany"]   = 3, ["Athletics"]    = 2, ["Mining"]    = 1, ["Cooking"]  = 1, ["Husbandry"] = 1 },
			...
			["Caretaker"] = new() { ["Healing"]  = 3, ["Social"]       = 2, ["Husbandry"] = 2, ["Crafting"]  = 1, ["Cooking"]  = 1 },
			["Guardian"]  = new() { ["Melee"]    = 3, ["Ranged"]       = 2, ["Athletics"] = 1, ["Husbandry"] = 1 },
